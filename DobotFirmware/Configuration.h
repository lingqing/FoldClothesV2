...
#define LOWERARM 135 //mm      Preprocessor cannot handle decimal point...
// Length of outer support arm     Measure arm lengths precisely and enter 
#define UPPERARM 170 //mm    

#define CENCER_OFFSET 65 //mm
#define HEAD_OFFSET 50 //mm

// DOBOT零点偏移设置
// This needs to be reasonably accurate as it defines the printbed position in the DOBOT space.
#define POS_OFFSET_X 230 //mm =>41.89
#define POS_OFFSET_Y 0 //mm =>-65.87
#define POS_OFFSET_Z -65 //mm
#define RAD2DEG 57.2957795  // to convert RAD to degrees
...
#define MANUAL_HOME_POS_E 0

#define PRINTABLE_RADIUS_MAX 340 //活动最大半径
#define PRINTABLE_RADIUS_MIN 80  //活动最小半径

//some helper variables to make kinematics faster
//#define L1_2 sq(Lowerarm) // do not change
//#define L2_2 sq(Upperarm) // do not change
...
#define CUSTOM_MENDEL_NAME "Dobot"
...
const bool E_MIN_ENDSTOP_INVERTING = true;
const bool E_MAX_ENDSTOP_INVERTING = true;
...
//DOBOT 角度运动范围
#define X_MAX_ANGLE 100
#define X_MIN_ANGLE -45//0
#define Y_MAX_ANGLE 50//90
#define Y_MIN_ANGLE -90//-90
...
#define Z_MIN_POS /*MANUAL_Z_HOME_POS*/0
...
// For DOBOT: Offset between HomingPosition and Bed X=0 / Y=0
#define MANUAL_X_HOME_POS -22.
#define MANUAL_Y_HOME_POS -52.
#define MANUAL_Z_HOME_POS 0.1  // Distance between nozzle and print surface after homing.
#define MANUAL_E_HOME_POS 0.1


//// MOVEMENT SETTINGS
#define NUM_AXIS 4 // The axis order in all axis related arrays is X, Y, Z, E
#define HOMING_FEEDRATE {10*60, 10*60, 10*60, 10*60}  // set the homing speeds (mm/min)

// default settings

//1/1.8*10*16
#define DEFAULT_AXIS_STEPS_PER_UNIT   {88.88889,88.88889,88.88889,240}  // default steps per unit for DOBOT
